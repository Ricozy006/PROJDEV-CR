...
# Charger et redimensionner l'image du poulet
poulet_img = pygame.image.load("poulet_img").convert_alpha()
poulet_img = pygame.transform.scale(poulet_img, (CUBE_SIZE, CUBE_SIZE))
...
while running:
    ...
    for c in cubes:
        # Affiche l'image du poulet à la place du cube
        screen.blit(poulet_img, (int(c["x"]), int(c["y"] - CUBE_SIZE//2)))
